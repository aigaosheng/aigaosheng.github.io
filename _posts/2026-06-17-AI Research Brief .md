...
- **URL**: [Read more](https://www.ttv.com.tw/finance/view/062026171442D0C4E2A08B5947BEBF48187BD5ACC1D9CC6D/588)

### 2. KAIST-MIT-Microsoft Develop "Upsample Anything" with 16x GPU Memory Efficiency
...
### 3. CuspAI Raising $400M at $2.6B Valuation with Jeff Bezos Backing
...
- **URL**: [Read more](https://www.siliconrepublic.com/start-ups/scientific-research-start-up-cuspai-to-raise-400m-with-jeff-bezos-among-backers-ft)

### 4. ModuLoop: AI Framework for Automatic Robot Control Code Generation and Debugging
...
- **URL**: [Read more](https://m.ajupress.com/view/20260617135520092)

### 5. Cathay Financial Holdings Shows Fine-Tuned SLMs Can Match Proprietary LLMs for Customer Intent
...
- **URL**: [Read more](https://en.antaranews.com/news/419439/cathay-financial-holdings-leverages-open-source-small-language-models-to-identify-customer-intent)

### 6-10. ArXiv AI Research Preprints (June 17, 2026)
