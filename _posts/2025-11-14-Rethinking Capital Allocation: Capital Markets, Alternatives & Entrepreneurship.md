...
* Institutional LPs expect to maintain or increase allocations to private markets, particularly:
...
* Retail access to alternatives, via feeder funds and tokenised structures, is accelerating.
...
1. **How are global allocators shifting exposures across public, private, and digital markets in 2025?**
2. **What role will private credit and secondaries play in solving liquidity challenges over the next cycle?**
3. **How should institutions evaluate operational and regulatory risks in tokenised and AI-enabled investment products?**
4. **Which geographies present the most compelling risk-adjusted opportunities under current policy realignments?**
5. **What must be true for digital asset and tokenisation markets to scale safely at institutional volumes?**
6. **Where should founders focus to build fintech infrastructure that institutions will actually adopt?**
