---
layout: post
title: "AI Governance, Risk and Compliance Brief — 2026-05-28"
series: "AI Governance & Regulation"
description: "EU Finalizes Omnibus Agreement, Delaying High-Risk AI Deadlines · Willis Warns of Dangerous Governance Gaps as AI Outpaces Oversight · New Banking Index…"
date: 2026-05-28 20:05:00 +0800
type: post
published: true
status: publish
categories: []
...
- EU AI Act
- GRC
keywords: [AI Governance, Risk Management, Compliance, EU AI Act, GRC, AI Liability]
permalink: /AI-Governance-Risk-Compliance-Brief-2026-05-28/
---
...
- **URL**: [EU AI Act Omnibus Agreement — Postponed High-Risk Deadlines and Other Key Changes](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/)
...
- **URL**: [AI exposures mounting across multiple lines, warns Willis](https://www.commercialriskonline.com/ai-exposures-mounting-across-multiple-lines-warns-willis/)
...
- **URL**: [AI Risk and Governance Index: Where US banking is scaling, exposing, and confronting AI risk — in real time](https://www.wolterskluwer.com/en/expert-insights/ai-risk-and-governance-index)
...
- **URL**: [EC-Council launches AI governance framework & tool](https://itbrief.co.nz/story/ec-council-launches-ai-governance-framework-tool)
...
- **URL**: [EU AI Act: accessibility as an emerging compliance requirement for high-risk AI systems - and a potential safety risk](https://ca.hoganlovells.com/en/publications/eu-ai-act-accessibility-as-an-emerging-compliance-requirement-for-highrisk-ai-systems)
...
- **URL**: [Diligent Named a Leader in Governance, Risk and Compliance Platforms in Q2 2026 Report by Independent Research Firm](https://www.rutlandherald.com/news/business/diligent-named-a-leader-in-governance-risk-and-compliance-platforms-in-q2-2026-report-by/article_fe1fe79a-47e2-5ed9-a4ce-912f78ea0927.html)
...
- **URL**: [Vanta Named a Leader Among Governance, Risk, and Compliance Platforms in First-Ever Inclusion](https://www.tmcnet.com/usubmit/2026/05/27/10389730.htm)
...
- **URL**: [Navigating AI risks: the launch of TrustAssure governance assessment](https://digests.digitalisationworld.com/news/72365/navigating-ai-risks-the-launch-of-trustassure-governance-assessment)
...
- **URL**: [Prophecy Emphasizes AI Governance and Risk Mitigation in Enterprise Workflows](https://www.tipranks.com/news/private-companies/prophecy-emphasizes-ai-governance-and-risk-mitigation-in-enterprise-workflows)
...
- **URL**: [Willis: Leaders must move from caution to control as AI reshapes risk and resilience](https://markets.businessinsider.com/news/stocks/willis-leaders-must-move-from-caution-to-control-as-ai-reshapes-risk-and-resilience-1036201875)
