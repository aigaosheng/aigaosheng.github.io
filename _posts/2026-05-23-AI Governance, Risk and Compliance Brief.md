...
- Anthropic
- Policy
keywords: [AI governance, AI compliance, risk management, Anthropic API, shadow AI, NIST, AI regulation]
permalink: /AI-Governance-Brief-2026-05-23/
---
...
- **URL**: [The week in GRC: Four states sue ISS on DEI and The White House pauses AI governance executive order](https://www.governance-intelligence.com/regulatory-compliance/week-grc-four-states-sue-iss-dei-and-white-house-pauses-ai-governance)
...
- **URL**: [SailPoint and Security Vendors Integrate Anthropic's Claude Compliance API for AI Governance](https://idtechwire.com/sailpoint-and-security-vendors-integrate-anthropics-claude-compliance-api-for-ai-governance/)
...
- **URL**: [Proofpoint extends oversight into Claude AI activity](https://itbrief.com.au/story/proofpoint-extends-oversight-into-claude-ai-activity)
