...
**1. Banking Circle**
A Luxembourg-regulated bank that provides institutional payment infrastructure, Banking Circle connects financial institutions directly to domestic and international clearing systems via a single API .
...
**2. Dharsi.ai**
A Dubai-based fintech start-up founded by banking tech veteran Dr Haroun Dharsey that has emerged from stealth to offer low-code solutions for financial institutions and SMEs .
