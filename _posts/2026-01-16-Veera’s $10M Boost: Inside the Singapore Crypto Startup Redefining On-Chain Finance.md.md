...
* **$4M Seed Round**, with lead commitments from CMCC Titan Fund and Sigma Capital plus strategic angel backers. ([FinSMEs][1])

Veera plans to channel the funding into accelerating **product development** and **global expansion** of its on-chain financial platform — building toward a future where everyday users can access decentralized financial tools without friction. ([AInvest][2])

## **What Veera Is Building: A Consumer-Ready On-Chain Financial OS**

At its core, Veera is designing a **mobile-first financial operating system** that unifies key decentralized finance (DeFi) products and services into a **single, intuitive interface**. The goal is to replace the fragmented experience of switching between decentralized apps (dApps) with something far simpler and more accessible. ([AInvest][2])
...
* **Veera Card waitlist** — a feature aimed at enabling on-chain spending globally. ([Bitget][3])
...
* **70,000+ holders of its RWA Gold Token (VGT)**
  …all since its launch in **January 2025**. ([FinSMEs][1])
...
Investors clearly see this as a differentiator. According to Sigma Capital’s Vineet Budki, Veera’s approach of aggregating yields, tokenized assets, and financial tools **lowers longstanding barriers between traditional finance and DeFi** — a key step toward broader financial inclusion. ([MEXC][4])
...
* **Deepen financial inclusion**, especially in **emerging markets** where mobile finance dominates users’ access to banking tools. ([AInvest][2])
...
**Source:** [https://www.techinasia.com/news/sg-crypto-startup-veera-raises-10m](https://www.techinasia.com/news/sg-crypto-startup-veera-raises-10m) ([Tech in Asia][5])

[1]: https://www.finsmes.com/2026/01/veera-raises-10m-in-pre-seed-and-seed-rounds.html "Veera Raises $10M in Pre-Seed and Seed Rounds"
[2]: https://www.ainvest.com/news/veera-raises-10-million-funding-expand-chain-financial-services-2601/ "Veera Raises $10 Million in Funding to Expand On-chain Financial Services"
[3]: https://www.bitget.com/amp/news/detail/12560605155903 "Singapore crypto startup Veera raises $10 million to expand on-chain financial services"
[4]: https://www.mexc.com/news/473543 "Veera Is Building Financial Infrastructure for How People Actually Use Crypto | MEXC News"
[5]: https://www.techinasia.com/news/sg-crypto-startup-veera-raises-10m "SG crypto startup Veera raises $10m"
