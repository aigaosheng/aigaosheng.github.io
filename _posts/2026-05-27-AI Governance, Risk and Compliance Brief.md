---
layout: post
title: "AI Governance, Risk and Compliance Brief — 2026-05-27"
series: "AI Governance & Regulation"
description: "EC-Council Launches AI Governance Framework with Input from Citi, Microsoft, and Salesforce · Forcepoint Extends AI Data Security to Claude Enterprise · EU…"
date: 2026-05-27 21:09:00 +0800
type: post
published: true
status: publish
categories: []
...
- AI Act
- Cybersecurity
keywords: [AI governance, risk management, compliance, EU AI Act, financial regulation, AI security, data protection]
permalink: /AI-Governance-Risk-Compliance-Brief-2026-05-27/
---
...
- **URL**: [EC-Council launches AI governance framework & tool](https://itbrief.com.au/story/ec-council-launches-ai-governance-framework-tool)
...
- **URL**: [Forcepoint Extends Unified AI and Data Security to Claude Enterprise](https://www.morningstar.com/news/business-wire/20260526199582/forcepoint-extends-unified-ai-and-data-security-to-claude-enterprise-stopping-risk-before-agents-act)
...
- **URL**: [EU AI Act: accessibility as an emerging compliance requirement for high-risk AI systems](https://ca.hoganlovells.com/en/publications/eu-ai-act-accessibility-as-an-emerging-compliance-requirement-for-highrisk-ai-systems)
...
- **URL**: [CDT Europe's AI Bulletin: May 2026](https://cdt.org/insights/cdt-europes-ai-bulletin-may-2026/)
...
- **URL**: [Tenable announces strategic integration with the Claude Compliance API](https://www.expresscomputer.in/news/tenable-announces-strategic-integration-with-the-claude-compliance-api-to-provide-unprecedented-visibility-and-governance-for-enterprise-ai-usage/135348/)
...
- **URL**: [Two regulators are rewriting the AI governance rules. What WA legal practitioners need to do now](https://briefonline.com.au/2026/05/27/two-regulators-are-rewriting-the-ai-governance-rules-what-wa-legal-practitioners-need-to-do-now/)

### 7. Federal Lawsuit Against OpenAI Over AI-Related Violence Proceeds
...
- **URL**: [AI Reporter - May 2026](https://www.lexology.com/library/detail.aspx?g=9583af8d-2665-4333-9156-88508b461551)
