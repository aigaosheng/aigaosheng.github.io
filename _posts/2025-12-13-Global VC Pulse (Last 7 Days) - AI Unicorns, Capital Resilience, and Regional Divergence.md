...
1. **Double down on enterprise AI with measurable ROI**
   Prioritize startups automating revenue-critical or cost-heavy enterprise functions.

2. **Use Europe for deep tech, not speed**
   Robotics, spatial AI, and industrial AI are strong fits—but require patient capital.

3. **Scout Asia aggressively at seed & Series A**
   Government support + improving founder quality = strong long-term optionality.

4. **Be disciplined on AI pricing**
   Favor repeatable revenue and defensibility over model novelty.
