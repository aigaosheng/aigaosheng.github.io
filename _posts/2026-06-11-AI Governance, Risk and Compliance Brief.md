...
- AI Regulation
- Financial Stability
keywords: [AI governance, risk management, compliance, AI Act, financial stability, agentic AI, transparency, AI safety]
permalink: /AI-Governance-Risk-Compliance-Brief-2026-06-11/
---
...
- **URL**: [Read more](https://indianexpress.com/article/technology/artificial-intelligence/anthropic-wants-tougher-ai-rules-10734024/)

### 2. FSB Warns Agentic AI Poses Distinct Risks to Financial Stability
...
- **URL**: [Read more](https://www.businesstimes.com.sg/companies-markets/telcos-media-tech/global-watchdog-calls-tighter-controls-agentic-ai-finance)

### 3. EU Publishes Final Code of Practice for AI-Generated Content Labeling
...
- **URL**: [Read more](https://digital-strategy.ec.europa.eu/en/news/commission-publishes-code-practice-marking-and-labelling-ai-generated-content)

### 4. UK MHRA Launches Regulatory Sandbox for AI Medical Devices in London
- **GOV.UK** · 2026-06-10
...
- **URL**: [Read more](https://www.gov.uk/government/news/pioneering-ai-health-innovations-regulatory-sandbox-launched)

### 5. Gartner: Organizations Must Move from Policy-Based to Enforceable AI Governance
- **Gartner** · 2026-06-10
...
- **URL**: [Read more](https://www.gartner.com/en/articles/ai-governance-trism)

### 6. Italian Government Approves Two Comprehensive AI Bills Implementing EU AI Act
...
- **URL**: [Read more](https://www.vietnam.vn/en/chinh-phu-italy-thong-qua-hai-du-luat-quan-ly-toan-dien-tri-tue-nhan-tao)

### 7. EU Opens Signatories for AI Transparency Code of Practice
- **EU Digital Strategy** · 2026-06-10
...
- **URL**: [Read more](https://digital-strategy.ec.europa.eu/en/library/how-sign-code-practice-transparency-ai-generated-content)

### 8. EU Commission Details Voluntary Code for AI Transparency Compliance
...
- **URL**: [Read more](https://www.vietnam.vn/en/eu-cong-bo-bo-quy-tac-yeu-cau-gan-nhan-noi-dung-do-ai-tao-ra)

### 9. European Commission Publishes French-Language Code of Practice on AI Content Labeling
...
- **URL**: [Read more](https://luxembourg.representation.ec.europa.eu/actualites-et-evenements/actualites/la-commission-publie-un-code-de-bonnes-pratiques-sur-le-marquage-et-letiquetage-des-contenus-generes-2026-06-10_fr)

### 10. Anthropic CEO Proposes Regulatory Framework Following Cybersecurity Incident
...
- **URL**: [Read more](https://www.cnbctv18.com/technology/anthropic-ceo-dario-amodei-pushes-government-for-stronger-ai-regulation-ws-l-19923545.htm)
