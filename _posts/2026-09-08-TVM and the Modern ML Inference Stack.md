...
series: "Tech stack"
description: "A practical guide to understanding Apache TVM and its role in the modern ML inference stack, comparing it with MLX, llama.cpp, ONNX Runtime, and TensorRT. The post explains the differences between frameworks, runtimes, and compilers, with a focus on LLM optimization, Apple Silicon, heterogeneous hardware, and custom AI accelerators."
