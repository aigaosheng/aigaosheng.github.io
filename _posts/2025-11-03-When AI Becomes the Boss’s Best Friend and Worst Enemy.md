...
1. **Centralised control and micromanagement**
   AI systems make it easier than ever for top management to track and measure everything. As Wooldridge writes: “The more the smart machines take over, the more skills atrophy and self‑direction withers.” ([bloomberg.com][2])
   So rather than freeing humans to be creative, AI can tighten the screws.

2. **Deskilling and loss of human agency**
   When machines make decisions—or support decisions—with little human input, staff may get trained to *react* rather than *act*. Wooldridge highlights that reliance on automation “trades brainpower for convenience”. ([facebook.com][3])
   In effect: the worker becomes the machine’s puppet.

3. **Reinforcing short‑term metrics and gaming the system**
   Because AI thrives on easily measurable data, management might focus more on what can be tracked (output, speed, compliance) than what matters (learning, adaptability, meaningful work). The result is optimisation of the *wrong things*.
