...
- Quantum AI
keywords: [AI research, OpenAI, Google DeepMind, AI agents, scientific discovery, quantum machine learning, mathematics]
permalink: /AI-Research-Brief-2026-05-22/
---
...
- **URL**: [OpenAI says its AI cracked a maths problem unsolved since 1946 without human help](https://www.techlusive.in/artificial-intelligence/openai-says-its-ai-cracked-a-maths-problem-unsolved-since-1946-without-human-help-1663345/)
...
- **URL**: [Artificial intelligence: AI research assistants that may accelerate scientific discovery](https://www.natureasia.com/en/info/press-releases/detail/9330)
...
- **URL**: [Google I/O showed how the path for AI-driven science is shifting](https://www.technologyreview.com/2026/05/22/1137813/google-i-o-showed-how-the-path-for-ai-science-is-shifting/)
...
- **URL**: [New Approach to Scaling Laws Could Change How AI Models Are Trained](https://hai.stanford.edu/news/new-approach-to-scaling-laws-could-change-how-ai-models-are-trained)
...
- **URL**: [Intrinsic preservation of plasticity in continual quantum learning](https://journals.aps.org/prxquantum/accepted/10.1103/ry52-85ll)
...
- **URL**: [AI & Science: What Is the Future of Discovery?](https://www.amacad.org/daedalus/ai-science-what-is-the-future-of-discovery)
...
- **URL**: [OpenAI has successfully disproven a mathematical conjecture that had remained unsolved for nearly 80 years](https://gigazine.net/gsc_news/en/20260521-openai-model-disproves-discrete-geometry-conjecture)
...
- **URL**: [OpenAI Breakthrough reshapes math, Claude audits, Google labs](https://blockchain.news/ainews/openai-breakthrough-reshapes-math-claude-audits-google-labs)
...
- **URL**: [OpenAI 推理模型突破性进展：AI 成功反驳 Erdős 单位距离猜想](https://www.chinaz.com/ainews/28213.shtml)