...
- Financial Services
- Cybersecurity
keywords: [AI Governance, Agentic AI, Financial Compliance, AI Risk Management, FSB]
permalink: /AI-Governance-Brief-2026-06-10/
---
...
- **URL**: [Global watchdog calls for tighter controls on agentic AI in finance](https://www.businesstimes.com.sg/companies-markets/telcos-media-tech/global-watchdog-calls-tighter-controls-agentic-ai-finance)
...
- **URL**: [AI governance gap widens as enterprises race to deploy agentic AI, IBM warns](https://www.fierce-network.com/cloud/ai-governance-gap-widens-enterprises-race-deploy-agentic-ai-ibm-warns)
...
- **URL**: [AI Governance Requires More Than Policies](https://www.gartner.com/en/articles/ai-governance-trism)
...
- **URL**: [Financial Services Industry Shifts from AI Adoption to Governance as Autonomous Systems Proliferate](https://cloudsecurityalliance.org/press-releases/2026/06/09/financial-services-industry-shifts-from-ai-adoption-to-governance-as-autonomous-systems-proliferate-cloud-security-alliance-survey-finds)
...
- **URL**: [18% of Singapore firms have AI security policies, but no tools to enforce](https://technode.global/2026/06/09/18-of-singapore-firms-have-ai-security-policies-but-no-tools-to-enforce/)

### 6. Legal Sector Faces Shadow AI Risk in Unmanaged Browsers
...
- **URL**: [Guest post: Client data, shadow AI, and the unmanaged browser](https://legaltechnology.com/guest-post-client-data-shadow-ai-and-the-unmanaged-browser/)
...
- **URL**: [Mythos and the New Regulatory Challenges of AI-Driven Cybersecurity](https://inplp.com/ch/latest-news/article/mythos-and-the-new-regulatory-challenges-of-ai-driven-cybersecurity/)
...
- **URL**: [3 Key Takeaways from Gartner SRM Summit 2026](https://safe.security/resources/blog/3-key-takeaways-from-gartner-srm-summit-2026/)
...
- **URL**: [AI, digital assets and the end of legacy compliance](https://fintech.global/2026/06/09/ai-digital-assets-and-the-end-of-legacy-compliance/)
...
- **URL**: [Agentic AI Is Already in Finance—Global Watchdog Warns Adoption Could Amplify Systemic Risk](https://www.ainvest.com/news/agentic-ai-finance-global-watchdog-warns-adoption-amplify-systemic-risk-2606/)
