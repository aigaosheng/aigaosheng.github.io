...
At its core, Graham’s essay says: almost every successful startup begins with manual, messy, unscalable efforts. Yes, building the product matters—but before automation, growth hacks, and viral loops, you need **sweat equity**: recruiting users one‑by‑one, obsessing over feedback, delighting early adopters, even doing things by hand until you can’t. According to Graham, ignoring this phase is a top mistake founders make. ([Paul Graham][1])
...
Graham uses the metaphor of a car engine with a hand‑crank: exceptional performance won’t take off by itself—you have to push it. ([Paul Graham][1]) Startups rarely just “go viral” out of the gate. Founders must recruit early users manually, test the product, refine it, and push it until the engine hums.
...
Rather than launching broadly, start **small**: pick a narrow market segment where you can ignite real engagement, then expand. The example: Facebook originally for Harvard students only—worth fewer users, but each one deeply engaged. ([Paul Graham][1]) This “contained fire” strategy lets you build momentum rather than spreading thin.

#### 4. Manual = learning

When you do things by hand (e.g., you are the “software,” you set up each user, you visit their homes) you intimately learn how the product is used, where it fails, what truly matters. That feedback loop is often faster and richer than designing everything for “automated scale” from day one. ([Paul Graham][1])

#### 5. Scaling comes later; don’t worship it at first

Founders often worry about scale too early—automation, big launches, large partner integrations. Graham says these are distractions at the very beginning: what matters is **depth**, not breadth. Launching wide with no depth usually fails. ([Paul Graham][1])
...
Source: [https://www.paulgraham.com/ds.html?utm_source=linkedin](https://www.paulgraham.com/ds.html?utm_source=linkedin)

[1]: https://www.paulgraham.com/ds.html?utm_source=linkedin "Do Things that Don't Scale"
