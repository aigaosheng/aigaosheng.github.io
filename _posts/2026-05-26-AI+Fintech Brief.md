...
- Digital Assets
- Agentic AI
keywords: [AI, Fintech, Regulation, Digital Assets, Agentic AI]
...
- **URL**: [NYDFS to Financial Sector: AI Is No Longer Just an Innovation Risk](https://securityboulevard.com/2026/05/nydfs-to-financial-sector-ai-is-no-longer-just-an-innovation-risk-it-is-a-cyber-vendor-consumer-protection-and-governance-risk/?ref=dailydev)

### 2. Fiserv Partners with OpenAI to Embed Frontier AI into Core Banking Platforms
- **Yahoo Finance** · 2026-05-25
- **Summary**: Fiserv announced a strategic collaboration with OpenAI to integrate frontier AI into its financial technology platforms. The partnership will focus on developing AI agents on Fiserv's new `agentOS` platform, streamlining complex bank modernization processes (like core conversions), and creating banking-specific AI models for cybersecurity.
- **Why It Matters**: This signals a major enterprise-level deployment of advanced AI directly into the legacy infrastructure that powers thousands of banks and credit unions. It validates that the next phase of fintech is not just customer-facing apps, but AI-driven optimization of core operations, risk reduction, and accelerated digital transformation for traditional institutions.
- **URL**: [Fiserv Partners With OpenAI to Integrate Frontier AI Across Financial Platforms](https://au.finance.yahoo.com/news/fiserv-fisv-partners-openai-integrate-195420754.html)
...
- **URL**: [AI Not Optional: Fintech Lendi Brings Employee AI Agent Use Into Performance Reviews](https://www.uctoday.com/talent-hcm-platforms/ai-not-optional-fintech-lendi-brings-employee-ai-agent-use-into-performance-reviews/)
...
- **URL**: [General Catalyst leads $63m funding round for travel card fintech Scapia](https://www.fintechfutures.com/venture-capital-funding/scapia-raises-63m)
...
- **URL**: [China-Pakistan B2B investment conference in Hangzhou highlights emerging cooperation in digital economy, AI and fintech](https://english.sdchina.com/show/2059080539230068738.html)
...
- **URL**: [Bybit CEO Ben Zhou: Tokenization Will Reshape Global Finance Faster Than Expected](https://coinmarketcap.com/community/articles/6a13f4a7fbd4b6598430b295/)
...
- **URL**: [Uzbekistan seeks Indian investment in fintech, AI](https://dailypioneer.com/news/uzbekistan-seeks-indian-investment-in-fintech-ai)
...
- **URL**: [Nava & Fluent Accelerate AI Finance & On-Chain Interaction](https://www.chaincatcher.com/article/2267256)
...
- **URL**: [Asia Fintech & Payments Regulatory Bulletin – May 2026](https://techinsights.linklaters.com/post/102msa8/asia-fintech-payments-regulatory-bulletin-may-2026)
...
- **URL**: [DC Cahalane on LinkedIn: #DTS #DublinTechSummit #AI #VentureCapital #Startups #Fintech](https://www.linkedin.com/posts/dcirl_dts-dublintechsummit-ai-activity-7464674272578334721-3wfJ)