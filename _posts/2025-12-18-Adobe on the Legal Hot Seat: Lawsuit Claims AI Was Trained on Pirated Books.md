...
* In **September 2025**, Anthropic agreed to a **$1.5 billion settlement** with authors over allegations its AI used pirated books — marking one of the largest payouts in AI copyright litigation. ([TechJuice][3])
* Apple and Salesforce have also faced lawsuits alleging they used RedPajama (and the underlying Books3 material) without permission to train their AI offerings. ([TechJuice][3])

Together, these cases underscore a growing legal fault line: **how AI developers source and justify the use of vast datasets that may include copyrighted works**. Courts may soon be called on to define the limits of “fair use” and determine whether downstream users like Adobe can be held liable for training on derivative datasets. ([The Outpost][2])
...
* **Creators’ Rights:** Writers and other content owners argue their work is being used unfairly to fuel commercial technology without compensation. ([The Outpost][2])
* **Data Transparency:** The case highlights the murky world of open-source datasets and the challenges companies face in verifying what’s actually in them. ([The Outpost][2])
* **Future of AI Development:** A ruling against Adobe could force companies to rethink how they gather and license training data — potentially increasing the cost and complexity of building AI models. ([Reuters][1])
...
Source: [https://www.techinasia.com/news/adobe-sued-alleged-misuse-authors-work-ai-training](https://www.techinasia.com/news/adobe-sued-alleged-misuse-authors-work-ai-training)

[1]: https://www.reuters.com/legal/government/adobe-sued-allegedly-misusing-authors-work-ai-training-2025-12-17/ "Adobe sued for allegedly misusing authors' work in AI training"
[2]: https://theoutpost.ai/news-story/adobe-faces-class-action-lawsuit-over-alleged-use-of-pirated-books-in-ai-training-22501/ "Adobe Lawsuit: Accused of AI Training on Pirated Books"
[3]: https://www.techjuice.pk/adobe-hit-with-class-action-lawsuit-for-using-pirated-books-to-train-ai/ "Adobe Hit with Class-Action Lawsuit: Used Pirated Books to Train AI"
