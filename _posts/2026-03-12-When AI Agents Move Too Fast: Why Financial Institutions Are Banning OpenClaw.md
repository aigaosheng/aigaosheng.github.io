...
Developed by Austrian software engineer **Peter Steinberger**, the project exploded in popularity after its release in late 2025. Within weeks, it accumulated hundreds of thousands of downloads and a massive following on GitHub. ([Wikipedia][2])

Its appeal was simple: OpenClaw promised a future where AI didn’t just answer questions—it **did the work**.

Users could connect the agent to messaging platforms such as WhatsApp, Telegram, Slack, or Discord and assign it tasks ranging from data analysis to email automation. ([Wikipedia][2])
...
According to reports, several banks, brokerages, and government agencies have **blocked employees from installing the tool on company devices**, citing potential cybersecurity threats and data-privacy risks. ([Tech in Asia][3])

The concerns stem from how OpenClaw works.

To perform tasks effectively, the AI agent often requires **broad system permissions**—including access to emails, calendars, messaging apps, local files, and external services. ([Wikipedia][4])
...
* Connectivity to external networks and services ([The Business Times][5])
...
Security researchers have already discovered **malicious extensions and fake versions of OpenClaw** circulating online. Some versions distributed through GitHub repositories have been used to install malware capable of stealing credentials and sensitive data. ([TechRadar][6])

Another vulnerability comes from OpenClaw’s plugin ecosystem.

The platform allows developers to create “skills” that expand the agent’s capabilities. However, some of these skills have been found to contain malware designed to extract crypto wallet keys, login credentials, and browser data. ([The Verge][7])

There are also deeper architectural risks.

Because OpenClaw relies on large language models to interpret instructions, it is vulnerable to **prompt injection attacks**—where malicious instructions hidden in content trick the AI into executing unintended commands. ([Wikipedia][4])
...
Researchers studying OpenClaw found that AI agents capable of executing system commands introduce significant vulnerabilities if not carefully controlled, particularly when interacting with untrusted data or external tools. ([arXiv][8])
...
Some governments and tech hubs are still actively encouraging experimentation with AI agents, offering subsidies and resources to developers building OpenClaw-based tools. ([Reuters][9])
...
**Agentic AI**
Artificial intelligence systems capable of independently performing tasks and interacting with software or digital environments.

**Prompt Injection**
A security attack where malicious instructions are embedded in input data to manipulate an AI model into performing unintended actions.

**AI Agent**
Software that uses AI models to autonomously plan and execute tasks using external tools, APIs, or system commands.

**Open-Source Software**
Software whose source code is publicly available for anyone to inspect, modify, and distribute.

**Plugin / Skill**
An extension that adds new capabilities to a platform, such as connecting an AI agent to external services or tools.

---

**Source:**
[https://www.techinasia.com/news/openclaw-ai-banned-financial-institutions-security-worries](https://www.techinasia.com/news/openclaw-ai-banned-financial-institutions-security-worries)
...
**Top 3 SEO Words:**
[AI agents, cybersecurity risk, enterprise AI]

[1]: https://zh.wikipedia.org/wiki/OpenClaw "OpenClaw"
[2]: https://pt.wikipedia.org/wiki/Openclaw "Openclaw"
[3]: https://www.techinasia.com/news/openclaw-ai-banned-financial-institutions-security-worries "OpenClaw AI banned at financial institutions over security ..."
[4]: https://en.wikipedia.org/wiki/OpenClaw "OpenClaw"
[5]: https://www.businesstimes.com.sg/companies-markets/banking-finance/china-moves-curb-openclaw-ai-use-banks-state-agencies "China moves to curb OpenClaw AI use at banks, state ..."
...
[7]: https://www.theverge.com/news/874011/openclaw-ai-skill-clawhub-extensions-security-nightmare "OpenClaw's AI 'skill' extensions are a security nightmare"
[8]: https://arxiv.org/abs/2603.10387 "Don't Let the Claw Grip Your Hand: A Security Analysis and Defense Framework for OpenClaw"
[9]: https://www.reuters.com/world/asia-pacific/chinas-shenzhen-backs-openclaw-ai-with-subsidies-despite-beijings-security-2026-03-09/ "Chinese tech hubs promote OpenClaw AI agent despite security warnings"
# When AI Agents Move Too Fast: Why Financial Institutions Are Banning OpenClaw
