...
* Sweet Security, co‑founded by retired Brig. Gen. Dror Kashti (former IDF CISO), Col. (ret.) Eyal Fisher (ex‑head of Cyber Dept., Unit 8200) and Orel Ben Ishay (former R&D leader in Unit 81), has raised $: 75 million. ([ctech][1])
* The round was led by investment firm Evolution Equity Partners, with participation from Munich Re Ventures, Glilot Capital Partners and Key1 Partners. ([ctech][1])
* The funding brings Sweet’s total raised to about $120 million in its roughly two‑and‑a‑half‑year existence. ([ctech][1])
* Sweet’s offering centres on a “cloud‑native application protection platform” (CNAPP) and runtime monitoring across code execution, identity, APIs, configuration risks and post‑attack behaviour. ([ctech][1])
* Of particular note: the startup is building out capabilities to discover, map and secure “shadow AI” agents and LLM‑powered services lurking inside enterprise environments. ([ctech][1])

---

### 🧠 Why it matters

* As organisations shift workloads to the cloud and adopt AI‑driven agents, traditional perimeter and API‑scan approaches are falling short. Sweet’s founders argue that runtime visibility — seeing how systems actually execute live — is the next frontier of cloud defence. ([SecurityWeek][2])
