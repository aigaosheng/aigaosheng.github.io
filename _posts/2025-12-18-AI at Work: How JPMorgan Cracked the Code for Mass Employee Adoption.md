...
**Large Language Model (LLM)** – A type of AI trained on massive text datasets that can generate and understand human-like language.
**Retrieval-Augmented Generation (RAG)** – An AI technique that combines generative models with external data sources to produce more accurate, context-rich outputs.
**Systems of Record** – Core enterprise databases or applications (e.g., CRM, finance, HR) that are authoritative sources of business information.

---

**Source:** [https://venturebeat.com/orchestration/jp-morgans-ai-adoption-hit-50-of-employees-the-secret-a-connectivity-first/](https://venturebeat.com/orchestration/jp-morgans-ai-adoption-hit-50-of-employees-the-secret-a-connectivity-first/)
