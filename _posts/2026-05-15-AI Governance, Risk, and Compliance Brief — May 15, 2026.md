...
keywords: [AI governance compliance, agentic AI risk management, D&O liability AI]
permalink: /AI Governance, Risk, and Compliance Brief — May 15, 2026/
---
...
*   **US Lawmakers Launch Probe into Five AI Giants**
    ...
    *   **URL** · [Lawler, Gottheimer Press for Accountability From AI Companies Ahead of 2026 Elections](https://lawler.house.gov/news/documentsingle.aspx?DocumentID=5910)
...
*   **Singapore Issues Governance Warning on Autonomous AI Agents**
    ...
    *   **URL** · [Singapore uses OpenClaw case study to signal AI governance risks](https://www.law360.com/mlex/artificial-intelligence/articles/2477554/singapore-uses-openclaw-case-study-to-signal-ai-governance-risks)
...
*   **UK Survey: 67% of Firms Hit by AI Data Leaks; Workers Fear Reporting**
    ...
    *   **URL** · [UK firms race ahead on AI, but controls lag behind](https://itbrief.co.uk/story/uk-firms-race-ahead-on-ai-but-controls-lag-behind)
...
*   **D&O Liability Surges as AI and Cyber Risks Reshape Board Accountability**
    ...
    *   **URL** · [AI, cybersecurity and geopolitical risks are reshaping board accountability](https://www.propertycasualty360.com/2026/05/14/ai-cybersecurity-and-geopolitical-risks-are-reshaping-board-accountability/)
...
*   **Information Integrity Tops Gartner's Emerging Risk List**
    ...
    *   **URL** · [Survey Finds Information Integrity Risk the Top Concern Among Risk Leaders](https://internalaudit360.com/survey-finds-information-integrity-risk-now-the-top-concern-among-risk-leaders/)
...
*   **OpenAI Proposes Global AI Governance Body Modeled on IAEA**
    ...
    *   **URL** · [OpenAI discusses creation of global AI governance body with US, China — Bloomberg](https://tass.com/economy/2131061)
