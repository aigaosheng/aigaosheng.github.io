---
layout: post
title: "Open-Source LLM Model Brief — 2026-07-02"
series: "AI Research & Open Source"
description: "China’s GLM-5.2 accelerates global open-model competition · Portugal launches “Amália,” its first national open-source LLM · Anthropic regains global…"
...
* **Reuters** · 2026-07-02
* **Summary**: Portugal has released “Amália,” a government-backed open-source LLM built with EU funding and academic collaboration. It is designed for public-sector applications including education, digital assistants, and defense decision support. ([Reuters][2])
* **Why It Matters**: This is a key milestone in Europe’s AI sovereignty strategy, signaling increased investment in public-interest open models to reduce dependency on U.S. and Chinese AI systems.
* **URL**: [https://www.reuters.com/business/finance/portugal-launches-first-open-source-ai-model-joining-europes-sovereignty-push-2026-07-01/](https://www.reuters.com/business/finance/portugal-launches-first-open-source-ai-model-joining-europes-sovereignty-push-2026-07-01/)

---

### 3. **Anthropic regains global access approval for Claude models amid AI export policy shift**

* **MarketWatch** · 2026-07-01
* **Summary**: U.S. regulators have lifted export restrictions on Anthropic’s latest Claude models, allowing broader international access ahead of the company’s expected IPO. This reverses a previous month-long limitation period. ([MarketWatch][3])
* **Why It Matters**: Policy normalization improves global deployment potential for frontier AI systems and highlights growing regulatory coordination around model safety and distribution.
* **URL**: [https://www.marketwatch.com/story/anthropic-gets-all-clear-to-let-foreigners-use-latest-model-ahead-of-crucial-ipo-a1ddc94a](https://www.marketwatch.com/story/anthropic-gets-all-clear-to-let-foreigners-use-latest-model-ahead-of-crucial-ipo-a1ddc94a)
...
* **URL**: [https://www.llmreference.com/pulse](https://www.llmreference.com/pulse)
...
* **URL**: [https://arxiv.org/abs/2604.04288](https://arxiv.org/abs/2604.04288)
